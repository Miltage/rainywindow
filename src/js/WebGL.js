export default class WebGL {
    ...
    static createProgram(gl, vertexScript, fragScript){
    ...
    static createShader(gl, script, type){
    ...
    static createTexture(gl, source, i){
    ...
    static createUniform(gl,program,type,name,...args){
        let location=gl.getUniformLocation(program,"u_"+name);
        gl["uniform"+type](location,...args);
    }

    static activeTexture(gl,i){
        gl.activeTexture(gl["TEXTURE"+i]);
    }

    static updateTexture(gl,source){
